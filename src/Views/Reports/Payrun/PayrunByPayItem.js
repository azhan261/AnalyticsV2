        ...
        <Row>
          <Col md="12">
            <Card className="card-plain">
              <CardHeader><h3>Pay Run by Pay Item</h3></CardHeader>
              <CardBody>
...
export default PayrunByPayItem
