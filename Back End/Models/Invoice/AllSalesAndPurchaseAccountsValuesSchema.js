...
var AllSalesAndPurchaseAccountsValuesSchema = mongoose.model('AllSalesAndPurchaseAccountsValuesSchema', {
    from:{ type: String},
    to : {type : String},
    type: {type: String},
    ...
    priceTotalUnitsWithoutSalesTaxVATAfterDiscount: {type: String},
    priceTotalUnitsWithoutSalesTaxVATAfterDiscount2: {type: String},
    priceTotalUnitsWithoutSalesTaxVATAfterDiscount3: {type: String},
    ...
    salesTaxVATinValue: {type: String},
    salesTaxVATinValue2: {type: String},
    salesTaxVATinValue3: {type: String},


    salesPriceAfterDiscountandInclusiveofSalesTaxVAT: {type: String},
    salesPriceAfterDiscountandInclusiveofSalesTaxVAT2: {type: String},
    salesPriceAfterDiscountandInclusiveofSalesTaxVAT3: {type: String},
    ...
    pricePerUnitWithoutSalesTaxVAT: {type: String},
    pricePerUnitWithoutSalesTaxVAT2: {type: String},
    pricePerUnitWithoutSalesTaxVAT3: {type: String},

    priceTotalUnitsWithoutSalesTaxVAT: {type: String},
    priceTotalUnitsWithoutSalesTaxVAT2: {type: String},
    priceTotalUnitsWithoutSalesTaxVAT3: {type: String},
    ...
    salesTaxVAT: {type: String},
    salesTaxVAT2: {type: String},
    salesTaxVAT3: {type: String},
...
module.exports = { AllSalesAndPurchaseAccountsValuesSchema };
